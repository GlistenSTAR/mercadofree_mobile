...
class SimpleUploadService {
    ...
    public $sizeLimit = 536870912;         // Max file upload size in bytes (default 512MB)
    ...
    public function handleUpload($uploadDir = null, $allowedExtensions = null) {
        ...
        /*$this->setErrorMsg($this->uploadDir);
            return false;*/
        ...
        while(file_exists($this->uploadDir . $this->fileName))
        {
            ...
            $this->fileName = $name.'_copy'. '.' .$extention;
        }
        ...
        $this->newFileName=rand(10000,99999).'.'.$this->fileExtension;

        $this->savedFile = $this->uploadDir . $this->newFileName;

//        echo $this->savedFile;die;
...
//        return true;
        ...
        return array(true,$this->newFileName);
    }
