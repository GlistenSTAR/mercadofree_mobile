$(document).ready(function () {
    ...
    function enviarStep2() {
        ...
        var count = 0;
        $('#containerImages input.imagenes-name').each(function (index, obj) {

            count++;
        });
        var radios = $('#containerImages .imagenes-name');
        var inputs = $('#containerImages .imagen-perfil');
        console.log(radios);
        console.log(inputs);
        // $('#containerImages .imagen-group').each(function (index, obj) {
        //
        ...
        var uploaderFotos = new ss.SimpleUpload({
            ...
            onComplete: function (filename, response) {
                ...
                if (response.success === true) {
                    var imagesRoute = $('#img-route-file').val();
